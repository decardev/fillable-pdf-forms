...
\startJScode {fn_AGE_calc}
	var d = value("df_dates_birth_day");	
	var m = value("df_dates_birth_month");
	var y = value("df_dates_birth_year");
	
	var date = new Date(y, m-1, d);
	var age =  ~~((Date.now() - date) / (31557600000));
	var valid = (	(date.getDate()) == d && 
								(date.getMonth() == m-1) && 
								(date.getFullYear() == y) &&
								(Date.now() > date));
							

	if (valid) { value("df_age", String(age) + " a\u00f1os"); }
	else {  
		value("df_age", "Fecha Invalida"); 
	}
\stopJScode
...
switch(event.target.name){
		...
		case "df_Z2_zona":  
			switch(event.target.value){
				...
				case "PTV_CMI": tipo = [" ", "Normo", "Normo 2", "Otro"]; 				 break;
...
\startJScode {fn_ZN_data}
	...
	var VM_id_normo = ["V4850 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4750 cGy", "D2\%", "\u2264", "5250 cGy"];
	var VM_ac_normo = ["V4750 cGy", "\u2265", "90\%", "D98\%", "\u2265", "4500 cGy", "D2\%", "\u2264", "5350 cGy"]; 
	var VM_fx_hipo  = ["4005 cGy", "=", "267 cGy", "\u00D7", "15"];
	var VM_id_hipo  = ["V3885 cGy", "\u2265", "95\%", "D98\%", "\u2265", "3800 cGy", "D2\%", "\u2264", "4205 cGy"];
	var VM_ac_hipo  = ["V3805 cGy", "\u2265", "90\%", "D98\%", "\u2265", "3600 cGy", "D2\%", "\u2264", "4285 cGy"]; 

	var LN_fx_normo = ["5000 cGy", "=", "200 cGy", "\u00D7", "25"];
	var LN_id_normo = ["V4750 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4500 cGy", "D2", "\u2264", "5250 cGy"];
	var LN_ac_normo = ["", "", "", "D98\%", "\u2265", "4275 cGy", "D2", "\u2264", "5350 cGy"]; 
	var LN_fx_hipo  = ["4005 cGy", "=", "267 cGy", "\u00D7", "15"];
	var LN_id_hipo  = ["V4750 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4500 cGy", "", "", ""];
	var LN_ac_hipo  = ["", "", "", "D98\%", "\u2265", "4275 cGy", "", "", ""]; 

	var CM_fx_normo = ["5000 cGy", "=", "200 cGy", "\u00D7", "25"];
	var CM_id_normo = ["V4750 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4500 cGy", "D2", "\u2264", "5250 cGy"];
	var CM_ac_normo = ["",      "",       "",     "D98\%", "\u2265", "4275 cGy", "D2", "\u2264", "5350 cGy"]; 
	var CM_fx_norm2 = ["4600 cGy", "=", "200 cGy", "\u00D7", "23"];
	var CM_id_norm2 = ["V4370 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4140 cGy", "D2", "\u2264", "4830 cGy"];
	var CM_ac_norm2 = ["",      "",       "",     "D98\%", "\u2265", "3933 cGy", "D2", "\u2264", "4922 cGy"]; 


	var CM_fx_hipo  = ["4005 cGy", "=", "267 cGy", "\u00D7", "15"];
	var CM_id_hipo  = ["V4750 cGy", "\u2265", "95\%", "D98\%", "\u2265", "4500 cGy", "", "", ""];
	var CM_ac_hipo  = ["", "", "", "D98\%", "\u2265", "4275 cGy", "", "", ""]; 

	var BT_fx_normo = ["1600 cGy", "=", "200 cGy", "\u00D7", "8"];
	var BT_id_normo = ["V1552 cGy", "\u2265", "95\%", "D2\%", "\u2264", "1712 cGy", "", "", ""];
	var BT_ac_normo = ["V1520 cGy", "\u2265", "90\%", "D5\%", "\u2264", "1760 cGy", "", "", ""]; 	
	...
	switch(event.target.name){
		...
		case "df_Z1_tipo":  
			switch(event.target.value){
				...
				case "Otro":            var fx = VM_fx_normo; var id = VM_id_normo; var ac = VM_ac_normo; var rw = [1, 1]; zona = [" ", "PTV_LN", "PTV_CMI", "BOOST"];    break;
		...
		case "df_Z2_tipo":  
			switch(event.target.value){
				...
				case "Normo 2": 
					var fx = CM_fx_norm2; var id = CM_id_norm2; var ac = CM_ac_norm2; var rw = [1, 0]; zona = [" ", "BOOST"]; break;
				case "Hipo":  
					switch(value("df_Z2_zona")){
				...
				case "Otro":        var fx = LN_fx_normo; var id = LN_id_normo; var ac = LN_ac_normo; var rw = [1, 1]; zona = [" ", "PTV_CMI", "BOOST"]; break;
				default:            var fx = zn_fx_deft; var id = "";          var ac = "";          var rw = [0, 1]; zona = [" "];                     break;
			}
		...
		case "df_Z3_tipo":  
			switch(event.target.value){
				...
				case "Otro":        var fx = CM_fx_normo; var id = CM_id_normo; var ac = CM_ac_normo; var rw = [1, 1]; zona = [" ", "BOOST"];           break;
				default:            var fx = zn_fx_deft; var id = "";          var ac = "";          var rw = [0, 1]; zona = [" "];                     break;
			}
		...
		case "df_Z4_tipo":  
			switch(event.target.value){
				...
				case "Otro":       var fx = BT_fx_normo;    var id = BT_id_normo; var ac = BT_ac_normo; var rw = [1, 1]; break;
...
\startJScode {fn_OAR_list}  
	...
	var oar_list = [
		...
		[
			["CORAZ\u00D3N",              "V2500 cGy < 5\% (10\%)", "V1500 cGy < 30\% (35\%)", "DMean < 400 cGy (550 cGy)"], 
			["PULM\u00D3N IPSILATERAL",   "V2000 cGy < 15\% (20\%)", "V1000 cGy < 35\% (40\%)", "V500 cGy < 50\% (55\%)"], 
			["PULM\u00D3N CONTRALATERAL", "V500 cGy < 30\%", "", ""], 	
			["MAMA CONTRALATERAL",        "V550 cGy < 10\% (15\%)", "DMean < 400 cGy (450 cGy)", ""], 
			["TIROIDES", 						      "V4000 cGy < 50\%", "DMax 0,03 cc < 2500 cGy", ""], 
			["M\u00C9DULA", 							"", "", ""], 
			["ES\u00D3FAGO", 						  "V3500 cGy < 50\% (60\%)",  "V5000 cGy < 2\% (5\%)", ""], 
			["H\u00DAMERO IPSILATERAL",	  "DMax 0,03 cc < 4000 cGy", "", ""], 
			["H\u00CDGADO", 							"V1500 cGy < 3\%", "", ""], 
		], 
		[
			["CORAZ\u00D3N",              "V2500 cGy < 0\% (2\%)", "V1500 cGy < 10\% (15\%)", "DMean < 400 cGy (550 cGy)"], 
			["PULM\u00D3N IPSILATERAL",   "V2000 cGy < 15\% (20\%)", "V1000 cGy < 35\% (40\%)", "V500 cGy < 50\% (55\%)"], 
			["PULM\u00D3N CONTRALATERAL", "V500 cGy < 30\%", "", ""], 	
			["MAMA CONTRALATERAL",        "V550 cGy < 10\% (15\%)", "DMean < 400 cGy (450 cGy)", ""], 
			["TIROIDES", 						      "V4000 cGy < 50\%", "DMax 0,03 cc < 2500 cGy", ""], 
		...
		[
			["CORAZ\u00D3N",            	"V2000 cGy < 5\%", "V200 cGy < 30\%", "DMean < 320 cGy (400 cGy)"], 
			["PULM\u00D3N IPSILATERAL",  	"V1200 cGy < 15\% (20\%)", "V800 cGy < 30\% (35\%)", "V400 cGy < 40\%"], 
			["PULM\u00D3N CONTRALATERAL", "V400 cGy < 10\%", "", ""], 
			["MAMA CONTRALATERAL",   			"V200 cGy < 5\% (10\%)", "DMean < 100 cGy (200 cGy)", "Dmax 0,03 cc < 240 cGy"], 
			["H\u00DAMERO IPSILATERAL",		"DMax 0,03 cc < 4000 cGy", "", ""], 
			["H\u00CDGADO",               "V1500 cGy < 3\%", "DMean < 440 cGy", ""], 
			["",                          "", "", ""],
			["",                          "", "", ""],
			["",                          "", "", ""],
		],
		[
			["CORAZ\u00D3N",              "V2500 cGy < 5\%", "V2000 cGy < 5\%", "V1000 cGy < 30\% (35\%)"],
			["",                          "DMean < 400 cGy (5 Gy)", "", ""],
			["PULM\u00D3N IPSILATERAL",   "V2000 cGy < 25\% (35\%)", "V1000 cGy < 50\% (65\%)", "V500 cGy < 65\% (75\%)"],
			["PULM\u00D3N CONTRALATERAL", "V500 cGy < 10\% (15\%)", "", ""],
			["MAMA CONTRALATERAL",        "V300 cGy < 5\% (10\%)", "DMean < 100 cGy (200 cGy)", ""],
			["TIROIDES", 						      "V4000 cGy < 50\%", "", ""],
			["M\u00C9DULA", 							"Dmax 0,03 cc < 2500 cGy", "", ""],
			["ES\u00D3FAGO", 						  "V3500 cGy < 50\% (60\%)", "V5000 cGy < 2\% (5\%)", ""],
			["H\u00DAMERO IPSILATERAL",	  "DMax 0,03 cc < 4000 cGy", "", ""],
		]
	];
	...
	if (value("df_Z1_tipo") == "Normo") { 
		if (value("df_Z1_zona") == "PTV_VMI") { vers = 1; } 
		if (value("df_Z1_zona") == "PTV_VMD") { vers = 2; }
		if (value("df_Z1_zona") == "PTV_VMI_VMD") { vers = 2; }
	}	
	if (value("df_Z1_tipo") == "Hipo") { vers = 3; }	
	if (value("df_Z2_zona") == "PTV_LN" || value("df_Z2_zona") == "PTV_CMI") { vers = 4; }
...
\setupheader
  ...
  [before={
		...
		\setupTABLE[c][align={middle, lohi}]
			\bTABLE
				\bTR 
					\bTD[nr=2, width=30mm, height=30mm, frame=on, rulethickness=1mm, align=center] \externalfigure[logo.jpg][height=27mm] \eTD 
				...
				\eTR
				\bTR
					\bTD[topframe=on, rulethickness=1mm] \tfb \bf PRESCRIPCIÓN MÉDICA \| MAMA\eTD 
				\eTR
		\eTABLE
		},
  after={},
...
\setupfield[sf_dates_birth_sm][height=4.5mm, width=4mm, frame=off, offset=0mm, align=flushleft, focusout=JS(fn_AGE_calc)]
\setupfield[sf_dates_birth_md][height=4.5mm, width=9mm, frame=off, offset=0mm, align=flushleft, focusout=JS(fn_AGE_calc)]
...
\definefield[df_ID_tipo][combo][sf_popup_short][DNI, ID, PASS]			
\definefield[df_ID][line][sf_number_medium] 			
\definefield[df_HC][line][sf_number_medium]


\definefield[df_dates_birth_day][line][sf_dates_birth_sm]
\definefield[df_dates_birth_month][line][sf_dates_birth_sm]
\definefield[df_dates_birth_year][line][sf_dates_birth_md]

\definefield[df_age][line][sf_number_medium]
\definefield[df_home][line][sf_text_medium]
\definefield[df_region][combo][sf_text_medium][ , Buenos Aires, CABA, Catamarca, Chaco, Chubut, Córdoba, Corrientes, Entre Ríos, Formosa, Jujuy, La Pampa, La Rioja, Mendoza, Misiones, Neuquén, Río Negro, Salta, San Juan, San Luis, Santa Cruz, Santa Fe, Santiago del Estero, Tierra del Fuego, Tucumán]
...
\definefield[df_social_number][line][sf_text_medium]
...
\definefield[sf_coment][text][sf_text_coment][Evitar hot spots fuera del PTV]
...
%\framed[strut=no,corner=round,offset=.5\linewidth,,rulethickness=1mm]\bgroup
	\bTABLE
		...
		\bTR 
			...
			\bTD[nc=1] \field[df_dates_birth_day] \eTD
			\bTD[nc=1, align=center] /\eTD
			\bTD[nc=1] \field[df_dates_birth_month] \eTD
			\bTD[nc=1, align=center] /\eTD
			\bTD[nc=2] \field[df_dates_birth_year] \eTD
			\bTD[nc=2] \eTD
